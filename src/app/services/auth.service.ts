...
httpOptionsFile: {headers: HttpHeaders}={
  ...
  deleteaccount(id)
  {
    return this.http.delete(`http://localhost:5000/auth/deleteaccount/${id}`, this.httpOptions);
  }

  updatehidephone(user)
  {
    return this.http.put(`http://localhost:5000/auth/updatehidephone`,user,this.httpOptions);
  ...
  showhiding(uid)
  {
    return this.http.get(`http://localhost:5000/auth/showhiding/${uid}`,this.httpOptions);
  }


  displayinterests(uid)
  {
    return this.http.get(`http://localhost:5000/auth/displayinterests/${uid}`,this.httpOptions);
  }
